  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-up">
      ...
      <div>
        ...
        <h1 class="reg_head"  style="color:Black;">Sign up</h1>
        ...
        <button type="submit" name="reg_user" class="reg_button pure-button pure-button-primary" onclick="validatePassword()" style="color:white; margin-top: 15px;">Register</button>
		...
		<div class="form-container sign-in-container">
          ...
          <div class="form-container sign-in-container">
            <form>
              <h1 class="reg_head" style="color:Black;"> Sign in</h1>				
              <input class="reg_input" name="username" type="message" placeholder="Enter User ID" id="account_id" required>
              <input class="reg_input" name="password_1" type="password" placeholder="Password" id="account_password" required>
              <a class="reg_a" href="forgot.php">Forgot your password?</a>
              <button name="login_user" class="reg_button" id="valid_account" style="color:white;">Sign In</button>
            </form>
          </div>
          <div class="overlayy-container">
            <div class="overlayy">
              <div class="overlayy-panel overlayy-left">
                <img src="assets/img/favicon-removebg.png" width="150px">
                <h2 class="reg_head" style="color:white;"> Hi Members </h2>
              ...
              <div class="overlayy-panel overlayy-right">
                <img style="margin-top: 30px;" src="assets/img/favicon-removebg.png" width="150px">
                <h2 class="reg_head" style="color:white;"> WELCOME ABOARD </h2>
                <p class="reg_p">Sign-Up to access our Services</p>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-5 col-lg-5 d-flex align-items-stretch mb-5 mb-lg-0">
            <a href="" onclick="alert('please register/login to access')">
